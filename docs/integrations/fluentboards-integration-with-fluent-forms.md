...
![fluentboards module in fluentform](../public/images/integrations/fluentboards-integration-with-fluent-forms/FluentBoards-Module-in-FluentForm-scaled.webp)
...
![fluentboards integration with forms](../public/images/integrations/fluentboards-integration-with-fluent-forms/FluentBoards-Integration-With-Forms-scaled.webp)
...
![form integration setup](../public/images/integrations/fluentboards-integration-with-fluent-forms/Form_Integration_Setup-793x1024.png)

Now, your task will be automatically generated upon form submission and placed into the board and stage you've chosen.

If you have any further questions, concerns, or suggestions related to this integration please do not hesitate to contact our [@support team](https://wpmanageninja.com/support-tickets/?utm_source=wpmn&utm_medium=home&utm_campaign=site#/){:target="_blank"}.